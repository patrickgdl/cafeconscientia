...
<figure class="extend">
    <img src="{{ 'alcoolmed.png' | media(page) }}" width="400" height="488" alt="Mascaras" style="border: 1px solid #BBB" />
...
<figure class="extend">
    <img src="{{ 'metabolismo.png' | media(page) }}" width="400" height="488" alt="Mascaras" style="border: 1px solid #BBB" />
...
<figure class="extend">
    <img src="{{ 'arcoxia.jpg' | media(page) }}" width="400" height="488" alt="Mascaras" style="border: 1px solid #BBB" />
...
<figure class="extend">
    <img src="{{ 'gardenal.jpg' | media(page) }}" width="400" height="488" alt="Mascaras" style="border: 1px solid #BBB" />
